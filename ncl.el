...
(defvar ncl-font-lock-keywords
   '(
    ...
    ;; NCL keywords
    ("\\<\\(begin\\|break\\|byte\\|character\\|continue\\|create\\|defaultapp\\|delete\\|do\\|double\\|else\\|end\\|enumeric\\|external\\|False\\|file\\|float\\|function\\|getvalues\\|graphic\\|group\\|if\\|integer\\|int64\\|load\\|local\\|logical\\|long\\|_Missing\\|Missing\\|new\\|noparent\\|numeric\\|procedure\\|quit\\|record\\|return\\|setvalues\\|short\\|snumeric\\|stop\\|string\\|then\\|True\\|undef\\|ubyte\\|uint\\|uint64\\|ulong\\|ushort\\|while\\|\\)\\>" 1 font-lock-keyword-face)
