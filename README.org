...
* ncl.el
The =ncl.el=  modified from the [[http://www.ncl.ucar.edu/Applications/Files/ncl.el][original]]

** Rewrite plan.
Parts of original =ncl.el= file has been modified/improved to accommodate
other files in this package.

I plan to rewrite whole =ncl.el= some time soon. Since the current
implementation really doesn't understand the NCL syntax And also I would like
this package to be in the core of Emacs or at least in official ELPA.
