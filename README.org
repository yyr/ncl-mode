...
* Installation
- Download the package from the latest release from [[http://www.ncl.ucar.edu/Applications/Files/ncl-mode/tags][here]] or development
version from [[http://www.ncl.ucar.edu/Applications/Files/ncl-mode/downloads][here]]
